...
#data=pd.read_csv('ClassificationData/7.Adult/adult.csv', header=None,sep=' *, *', na_values='?')
#data=pd.read_csv('ClassificationData/8. Yeast/yeast.csv', header=None)
#data=pd.read_csv('ClassificationData/9. Thoracic Surgery Data/ThoraricSurgery.csv', header=0)
data=pd.read_csv('ClassificationData/10. Seismic-Bumps/seismic-bumps.csv', header=None)
...
#data.columns = [ "Age", "WorkClass", "fnlwgt", "Education", "EducationNum",    "MaritalStatus", "Occupation", "Relationship", "Race", "Gender",   "CapitalGain", "CapitalLoss", "HoursPerWeek", "NativeCountry", "Income"]


#ref: https://towardsdatascience.com/encoding-categorical-features-21a2651a065c
#Handle MissingValues--use string 'zero' to substitude '？'
...
print(data.NativeCountry.unique())
MultiColumnLabelEncoder(columns = ["NativeCountry"]).fit_transform(data)

print(data["NativeCountry"])
